function startup() {
    ...
    function buttonClicked() {
        ...
        xhr.onload = function () {
           ...
           nl.innerHTML = `<a href="List-of-Provinces/pages/second.html?name=${provincesData[4].name}"><img class="flag-img" src="${provincesData[4].flag}" alt="${provincesData[4].name}" /> <br> ${provincesData[4].name}</a>`;
           ns.innerHTML = `<a href="List-of-Provinces/pages/second.html?name=${provincesData[5].name}"><img class="flag-img" src="${provincesData[5].flag}" alt="${provincesData[5].name}" /> <br> ${provincesData[5].name}</a>`;
           on.innerHTML = `<a href="List-of-Provinces/pages/second.html?name=${provincesData[6].name}"><img class="flag-img" src="${provincesData[6].flag}" alt="${provincesData[6].name}" /> <br> ${provincesData[6].name}</a>`;
           pe.innerHTML = `<a href="List-of-Provinces/pages/second.html?name=${provincesData[7].name}"><img class="flag-img" src="${provincesData[7].flag}" alt="${provincesData[7].name}" /> <br> ${provincesData[7].name}</a>`;
           qc.innerHTML = `<a href="List-of-Provinces/pages/second.html?name=${provincesData[8].name}"><img class="flag-img" src="${provincesData[8].flag}" alt="${provincesData[8].name}" /> <br> ${provincesData[8].name}</a>`;
           sk.innerHTML = `<a href="List-of-Provinces/pages/second.html?name=${provincesData[9].name}"><img class="flag-img" src="${provincesData[9].flag}" alt="${provincesData[9].name}" /> <br> ${provincesData[9].name}</a>`;
